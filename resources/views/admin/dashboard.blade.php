...
@section('content')
    <!-- Aquí coloca el contenido específico del dashboard, que puede ser la parte que empieza con -->
    ...
    <!-- Aquí continúa el resto de tu contenido (tarjetas, tablas, gráficos, etc.) -->
@endsection
